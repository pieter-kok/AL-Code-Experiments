report 50200 "Image Library CPTE"
{
    ...
    dataset
    {
        dataitem(ImageLibrary; "Image Library CPTE")
        {
    ...
    local procedure Resize(var TempTenantMedia: Record "Tenant Media" temporary; RequestedWidth: Integer; RequestedHeight: Integer)
    var
        ...
        NewHeight: Integer;
    begin
        TempTenantMedia.Content.CreateInStream(ImageInStream);
        ...
        TempTenantMedia.Content.CreateOutStream(ImageOutStream);
