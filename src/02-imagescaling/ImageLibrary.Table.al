table 50201 "Image Library CPTE"
{
    DataCaptionFields = "Entry No.", Description;
    DataClassification = CustomerContent;
    DrillDownPageId = "Image Library List CPTE";
    LookupPageId = "Image Library List CPTE";
    ...
    var
        ImageLibraryHelper: Codeunit "Image Library Helper CPTE";
