codeunit 50201 "Image Library Helper CPTE"
{
    var
    ...
    internal procedure ImportImage(var ImageLibrary: Record "Image Library CPTE"; CalledFromFieldNo: Integer)
    var
    ...
    internal procedure DeleteImage(var ImageLibrary: Record "Image Library CPTE"; CalledFromFieldNo: Integer)
    begin
    ...
    internal procedure ExportImageFromMedia(var ImageLibrary: Record "Image Library CPTE"; CalledFromFieldNo: Integer)
    var
    ...
    internal procedure ExportBase64(var ImageLibrary: Record "Image Library CPTE"; CalledFromFieldNo: Integer)
    var
    ...
    internal procedure SaveTargetImage(var ImageLibrary: Record "Image Library CPTE"; var Image: Codeunit Image)
    var
        TempBlob: Codeunit "Temp Blob";
        ImageInStream: InStream;
        ImageOutStream: OutStream;
    ...
    internal procedure CropImage(var ImageLibrary: Record "Image Library CPTE")
    var
        Image: Codeunit Image;
    begin
    ...
    internal procedure ResizeImage(var ImageLibrary: Record "Image Library CPTE")
    var
        Image: Codeunit Image;
    begin
        if ImageLibrary."Target Base64".HasValue then
    ...
    internal procedure PrintImageLibrary(var ImageLibrary: Record "Image Library CPTE")
    begin
        Report.Runmodal(Report::"Image Library CPTE", true, false, ImageLibrary);
    end;

    local procedure GetBase64Text(var ImageLibrary: Record "Image Library CPTE"; CalledFromFieldNo: Integer) Base64Text: Text
    var
        Base64InStream: InStream;
    begin
        case CalledFromFieldNo of
    ...
    local procedure ConfirmOverrideImage(var ImageLibrary: Record "Image Library CPTE"; CalledFromFieldNo: Integer): Boolean
    var
        TenantMedia: Record "Tenant Media";
    begin
        case CalledFromFieldNo of
    ...
    local procedure InitializeImageLibrary(var ImageLibrary: Record "Image Library CPTE")
    begin
