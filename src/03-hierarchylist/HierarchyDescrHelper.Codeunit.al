codeunit 50202 "Hierarchy Descr. Helper CPTE"
{
    internal procedure GetStyleExpr(var HierarchyDescr: Record "Hierarchy Descr. CPTE") StyleExpr: Text;
    var
    ...
    local procedure OnCustomGetStyleExpr(Style: Enum "Hierarchy Style CPTE"; var StyleExpr: Text)
    begin
    end;
}
